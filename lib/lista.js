...
export class Lista {
    ...
    elimina_X(x){
        ...
        if(BAND == 0)
            window.alert("EL ELEMENTO CON INFORMACION " + x + " NO SE ENCUENTRA EN LA LISTA");
        else if(P == Q)
            P = Q.liga;
        else
            T.liga = Q.liga;
    ...
    elimina_antes_X(x){
        ...
        if(P.info == x)
            window.alert("No existe un nodo que precede al que contiene a " + x);
        else{
            Q = P;
            T = P;
            BAND = 1;
            ...
            if(BAND == 0)
                window.alert("EL ELEMENTO NO SE ENCUENTRA EN LA LISTA");
            else if(P.liga == Q)
                P = Q;
            else
                R.liga = Q;
